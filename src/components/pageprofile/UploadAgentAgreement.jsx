...
const UploadAgentAgreement = ({ open, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md relative overflow-y-auto max-h-[95vh]">
        {/* Header */}
        ...
        <p className="text-gray-500 text-base mb-1 px-6">Attach Agreement</p>
        ...
        <p className="text-gray-500 text-base mb-1 px-6">Attach Agent’s Commercial Registration</p>
        <div className="mb-6 px-6">
          <div 
            className="border-2 border-dashed border-gray-300 rounded-lg p-10 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition"
        ...
        {/* Attach Proof of Brand Ownership or Authorization */}
        <p className="text-gray-500 text-base mb-1 px-6">Attach Proof of Brand Ownership or Authorization</p>
        <div className="mb-6 px-6">
          <div 
            className="border-2 border-dashed border-gray-300 rounded-lg p-10 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition"
            onClick={handleLegalProofClick}
        ...
        {/* Attach Signed, Stamped English Confirmation Letter */}
        <p className="text-gray-500 text-base mb-1 px-6">Attach Signed, Stamped English Confirmation Letter</p>
        <div className="mb-6 px-6">
          <div 
            className="border-2 border-dashed border-gray-300 rounded-lg p-10 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition"
            onClick={handleLegalProofClick}
...
export default UploadAgentAgreement;