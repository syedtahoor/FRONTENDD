...
const ViewAgenciesDetails = ({ open, onAgreementUpload, onClose, agency, readable = true }) => {
  if (!open) return null;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
      <div className="bg-white rounded-lg hide-scrollbar shadow-lg w-full max-w-lg p-0 relative overflow-y-auto max-h-[95vh] border border-[#7c87bc]">
        ...
        <div className="px-6 mt-4 mb-8 flex items-center gap-x-4">
            <h1 className="text-lg font-medium">I confirm this data is correct.</h1>
            <div className="flex items-center gap-x-4">
                <span className="bg-gradient-to-b from-[#FF7575] to-[#FF0000] rounded-md p-1 cursor-pointer"><X className="w-8 h-8 text-white" /></span>
                <span className="bg-gradient-to-b from-[#60E06C] to-[#07B017] rounded-md p-1 cursor-pointer"><Check className="w-8 h-8 text-white" /></span>
            </div>
        </div>

        <button onClick={onAgreementUpload} className="bg-[#0017E7] mx-6 mb-8 flex items-center gap-x-2 text-white px-2 py-2 rounded-md"><Upload className="w-6 h-6" /> Upload Agreement</button>
      </div>
...
export default ViewAgenciesDetails;