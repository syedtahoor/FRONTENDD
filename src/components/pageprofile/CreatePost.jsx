...
export default function CreatePost({ onClose, onOpenPoll, pageId }) {
  ...
  useEffect(() => {
    console.log("Page ID received:", pageId, "Type:", typeof pageId);
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/pages/textposts`,
        {
