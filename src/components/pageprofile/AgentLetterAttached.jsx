...
import MyAgentsConfirmationLetter from "./MyAgentsConfirmationLetter";
  ...
  <div className="border border-black rounded-lg bg-white p-6 flex flex-col gap-2 mb-5 relative  mx-auto">
    ...
    <div className=" mt-2">
      <button
        ...
        onClick={setShowConfLetterPopup}
      >
...
const AgentLetterAttached = () => {
  ...
  return (
    ...
    <h1 className="text-3xl font-bold font-sf mb-6">Letter Attached</h1>
      ...
      {showConfLetterPopup && (
        <MyAgentsConfirmationLetter open={showConfLetterPopup} onClose={() => setShowConfLetterPopup(false)} readable={true} />
      )}
...
export default AgentLetterAttached;
