...
import ViewAgenciesDetails from './ViewAgenciesDetails';
import UploadAgencyAgreement from './UploadAgencyAgreement';
...
const AgenciesInvitations = () => {
  ...
  return (
    <div className="mt-2 px-10">
      ...
      {showUploadModal && (
        <UploadAgencyAgreement open={showUploadModal} onClose={() => setShowUploadModal(false)} />
      )}
    </div>
  );
};

export default AgenciesInvitations;