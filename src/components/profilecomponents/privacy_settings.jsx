    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
      <div className="bg-white rounded-md shadow-2xl w-full max-w-md animate-fadeIn">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 px-6 pt-6 pb-4">
          <h2 className="text-2xl font-medium text-black font-sf">Privacy Setting</h2>
          <button
        ...
        <div className="px-6 pt-6 pb-4">
          <div className="flex items-center justify-between border rounded-md px-4 py-3 mb-4 bg-gray-50">
            <span className="font-sf text-lg font-medium text-black">Private Account</span>
            <button
          ...
          <div className="text-gray-600 text-sm font-sf leading-relaxed">
            Manage who can see your profile and activity.<br />
            You can control the visibility of your education, memberships, and contact info. Choose what you want to keep public or private and update your preferences anytime.
          </div>
        </div>
      </div>
    </div>
